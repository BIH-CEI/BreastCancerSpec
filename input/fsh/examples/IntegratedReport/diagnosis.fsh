// Bestätigte Diagnose Mammakarzinom — integrierter Bericht BET + SLN
Instance: IntegratedDiagnosisConfirmed
InstanceOf: $mii-diagnose
Usage: #example
Title: "Mammakarzinom-Diagnose (integrierter Bericht)"
...
* note.text = "Z.n. Stanzbiopsie (E_25_105) mit Nachweis eines invasiven Mammakarzinoms NST, G2. BI-RADS 4b. BET links mit SLN-Biopsie Axilla indiziert."
