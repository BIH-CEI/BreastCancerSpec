...
* category[laboratory-category] = $observation-category#laboratory
* category[section-type] = $loinc#22637-3
* code = $loinc#85318-4 "HER2 [Presence] in Breast cancer specimen by FISH"
...
* category[laboratory-category] = $observation-category#laboratory
* category[section-type] = $loinc#22637-3
* code = $sct#1197541006 "Lesion classification of breast biopsy by National Health Service breast screening programme (observable entity)"
...
* category[laboratory-category] = $observation-category#laboratory
* category[section-type] = $loinc#22637-3
* code = $sct#396779001 "Microcalcification (morphologic abnormality)"
...
* category[laboratory-category] = $observation-category#laboratory
* category[section-type] = $loinc#22637-3
* code = $sct#168537006 "Specimen radiology (procedure)"
