...
* specimen[+] = Reference(CoreNeedleBiopsySpecimenSlideHE02)
* specimen[+] = Reference(CoreNeedleBiopsySpecimenSlideHE03)
* specimen[+] = Reference(CoreNeedleBiopsySpecimenSlideHE04)
* specimen[+] = Reference(CoreNeedleBiopsySpecimenSlideER01)
* specimen[+] = Reference(CoreNeedleBiopsySpecimenSlideER02)
* specimen[+] = Reference(CoreNeedleBiopsySpecimenSlidePR01)
* specimen[+] = Reference(CoreNeedleBiopsySpecimenSlidePR02)
* specimen[+] = Reference(CoreNeedleBiopsySpecimenSlideHER2-01)
* specimen[+] = Reference(CoreNeedleBiopsySpecimenSlideHER2-02)
* specimen[+] = Reference(CoreNeedleBiopsySpecimenSlideKi67-01)
* specimen[+] = Reference(CoreNeedleBiopsySpecimenSlideKi67-02)
