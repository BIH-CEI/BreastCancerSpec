# HE-Schnitt 04 BET - Tumor - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt 04 BET - Tumor**

## Example Specimen: HE-Schnitt 04 BET - Tumor
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_25_210_A_1_1_HE_04
...
> **processing****MII EX Biobank Temperaturbedingungen**: 20-25 °C**description**: Schnittherstellung (Schnittstufe 4)**procedure**: Sectioning of tissue block (procedure)**time**: 2025-02-06 09:00:00+0100
