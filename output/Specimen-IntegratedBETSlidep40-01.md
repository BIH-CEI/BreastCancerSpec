# p40-IHC Schnitt BET (integriert) - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **p40-IHC Schnitt BET (integriert)**

## Example Specimen: p40-IHC Schnitt BET (integriert)
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_25_300_A_1_1_p40_01
...
> **processing****MII EX Biobank Temperaturbedingungen**: 20-25 °C**description**: p40-Immunhistochemie**procedure**: Immunohistochemistry procedure (procedure)**additive**: [Substance Tissue stain (substance)](Substance-IntegratedSubstancep40.md)**time**: 2025-02-06 10:00:00+0100
