# SLN #1 Größe (integriert) - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SLN #1 Größe (integriert)**

## Example Observation: SLN #1 Größe (integriert)
...
**specimen**: [Specimen: identifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_25_300_B_1; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_25_300; status = available; type = Tissue block specimen (specimen)](Specimen-IntegratedSLNSpecimenBlock01.md)
