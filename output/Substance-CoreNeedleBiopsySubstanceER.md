# ER-IHC Reagenz Stanzbiopsie - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ER-IHC Reagenz Stanzbiopsie**

## Example Substance: ER-IHC Reagenz Stanzbiopsie
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySubstanceER",
  "meta" : {
