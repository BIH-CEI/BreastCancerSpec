# Progesteronrezeptor-Status - BET - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Progesteronrezeptor-Status - BET**

## Example Observation: Progesteronrezeptor-Status - BET
...
**code**: Hormonrezeptorstatus Progesteron
...
**specimen**: [Specimen: identifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_25_300_A_1_1_PR_01; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_25_300; status = available; type = Tissue section (specimen)](Specimen-IntegratedBETSlidePR01.md)
