# HE-Schnitt RR superior BET (integriert) - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt RR superior BET (integriert)**

## Example Specimen: HE-Schnitt RR superior BET (integriert)
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_25_300_A_3_1_HE_01
...
**parent**: [Specimen: identifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_25_300_A_3; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_25_300; status = available; type = Tissue block specimen (specimen)](Specimen-IntegratedBETSpecimenBlock03.md)
