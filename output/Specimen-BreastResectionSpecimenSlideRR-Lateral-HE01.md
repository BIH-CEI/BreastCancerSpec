# HE-Schnitt BET - RR lateral (Block06) - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt BET - RR lateral (Block06)**

## Example Specimen: HE-Schnitt BET - RR lateral (Block06)
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_25_210_A_6_1_HE_01
...
**parent**: [Specimen: identifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_25_210_A_6; accessionIdentifier = https://pathologie.example-hospital.de/fhir/fn/befundbericht#E_25_210; status = available; type = Tissue block specimen (specimen)](Specimen-BreastResectionSpecimenBlock06.md)
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2025-02-06 09:34:00+0100 | Tissue processing technique (procedure) |

> **processing****MII EX Biobank Temperaturbedingungen**: 20-25 °C**description**: Schnittherstellung**procedure**: Sectioning of tissue block (procedure)**time**: 2025-02-06 09:34:00+0100

> **processing****MII EX Biobank Temperaturbedingungen**: 20-25 °C**description**: HE-Färbung**procedure**: Hematoxylin and eosin stain method (procedure)**time**: 2025-02-06 09:49:00+0100
