# Paraffinblock 05 BET - RR medial (integriert) - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Paraffinblock 05 BET - RR medial (integriert)**

## Example Specimen: Paraffinblock 05 BET - RR medial (integriert)
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_25_300_A_5
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2025-02-06 08:40:00+0100 | Gross examination and sampling of tissue specimen (procedure) |
...
| * |  | Zuschnitt und Paraffineinbettung - RR medial, Scheibe I | Preparation of formalin fixed paraffin embedded tissue specimen (procedure) | 2025-02-06 08:40:00+0100 |
