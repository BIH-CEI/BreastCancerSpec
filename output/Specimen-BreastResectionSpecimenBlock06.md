# Paraffinblock 06 BET - RR lateral (Scheibe VIII) - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Paraffinblock 06 BET - RR lateral (Scheibe VIII)**

## Example Specimen: Paraffinblock 06 BET - RR lateral (Scheibe VIII)
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_25_210_A_6
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2025-02-06 08:35:00+0100 | Gross examination and sampling of tissue specimen (procedure) |
...
| * |  | Zuschnitt und Paraffineinbettung - Resektionsrand lateral (Scheibe VIII) | Preparation of formalin fixed paraffin embedded tissue specimen (procedure) | 2025-02-06 08:35:00+0100 |
