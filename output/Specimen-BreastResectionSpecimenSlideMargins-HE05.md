# HE-Schnitt 05 BET - Resektionsränder - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt 05 BET - Resektionsränder**

## Example Specimen: HE-Schnitt 05 BET - Resektionsränder
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_25_210_A_3_1_HE_05
...
> **processing****MII EX Biobank Temperaturbedingungen**: 20-25 °C**description**: Schnittherstellung (Schnittstufe 5)**procedure**: Sectioning of tissue block (procedure)**time**: 2025-02-06 09:25:00+0100
