# HER2-IHC Reagenz Stanzbiopsie - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HER2-IHC Reagenz Stanzbiopsie**

## Example Substance: HER2-IHC Reagenz Stanzbiopsie
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySubstanceHER2IHC",
  "meta" : {
