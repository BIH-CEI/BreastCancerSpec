# BET-Exzisionspräparat (integriert) - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **BET-Exzisionspräparat (integriert)**

## Example Specimen: BET-Exzisionspräparat (integriert)
...
**identifier**: Placer Identifier/OP25_300_A, Filler Identifier/E_25_300_A
...
BET-Exzisionspräparat Mamma links, unterer äußerer Quadrant, 5 Uhr, 50 mm von Mamille. 42 × 35 × 18 mm, 10 g. Haut anhängend, Drahthäkchen in situ. Lamellierung in 8 Scheiben à 5 mm. Schnittfläche: grau-weißlicher Herdbefund zentral in Scheibe III–V, ca. 18 mm.
