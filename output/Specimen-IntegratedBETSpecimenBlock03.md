# Paraffinblock 03 BET - RR superior (integriert) - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Paraffinblock 03 BET - RR superior (integriert)**

## Example Specimen: Paraffinblock 03 BET - RR superior (integriert)
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_25_300_A_3
...
| * |  | Zuschnitt und Paraffineinbettung - RR superior | Preparation of formalin fixed paraffin embedded tissue specimen (procedure) | 2025-02-06 08:20:00+0100 |
