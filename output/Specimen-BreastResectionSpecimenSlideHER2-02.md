# HER2-B-DISH Schnitt 02 BET - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HER2-B-DISH Schnitt 02 BET**

## Example Specimen: HER2-B-DISH Schnitt 02 BET
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_25_210_A_1_1_HER2_02
...
> **processing****MII EX Biobank Temperaturbedingungen**: 20-25 °C**description**: HER2 Bright-field Dual In-Situ Hybridization (B-DISH)**procedure**: Fluorescence in situ hybridization (procedure)**time**: 2025-02-06 10:30:00+0100
