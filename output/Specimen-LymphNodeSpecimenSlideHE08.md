# HE-Schnitt 08 SLN #2 (Schnittstufe 3) - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt 08 SLN #2 (Schnittstufe 3)**

## Example Specimen: HE-Schnitt 08 SLN #2 (Schnittstufe 3)
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_25_211_A_2_1_HE_03
...
> **processing****MII EX Biobank Temperaturbedingungen**: 20-25 °C**description**: Schnittherstellung (Schnittstufe 3)**procedure**: Sectioning of tissue block (procedure)**time**: 2025-02-06 09:20:00+0100
