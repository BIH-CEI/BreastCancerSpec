# Probengröße 1 (Länge) (integriert) - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Probengröße 1 (Länge) (integriert)**

## Example Observation: Probengröße 1 (Länge) (integriert)
...
**value**: 42 mm (Details: UCUM codemm = 'mm')
