# Probengröße 3 (Tiefe) BET - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Probengröße 3 (Tiefe) BET**

## Example Observation: Probengröße 3 (Tiefe) BET
...
**value**: 30 mm (Details: UCUM codemm = 'mm')
