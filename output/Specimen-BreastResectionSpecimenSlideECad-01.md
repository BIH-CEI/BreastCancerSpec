# E-Cadherin-IHC Schnitt BET (Block01) - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **E-Cadherin-IHC Schnitt BET (Block01)**

## Example Specimen: E-Cadherin-IHC Schnitt BET (Block01)
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_25_210_A_1_1_ECad_01
...
| :--- | :--- | :--- |
| - | **Collected[x]** | **Method** |
| * | 2025-02-06 10:00:00+0100 | Tissue processing technique (procedure) |

> **processing****MII EX Biobank Temperaturbedingungen**: 20-25 °C**description**: Schnittherstellung**procedure**: Sectioning of tissue block (procedure)**time**: 2025-02-06 10:00:00+0100

> **processing****MII EX Biobank Temperaturbedingungen**: 20-25 °C**description**: E-Cadherin-Immunhistochemie**procedure**: Immunohistochemistry procedure (procedure)**additive**: [Substance Tissue stain (substance)](Substance-BreastResectionSubstanceECadherin.md)**time**: 2025-02-06 10:45:00+0100
