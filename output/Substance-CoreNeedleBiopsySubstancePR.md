# PR-IHC Reagenz Stanzbiopsie - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **PR-IHC Reagenz Stanzbiopsie**

## Example Substance: PR-IHC Reagenz Stanzbiopsie
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySubstancePR",
  "meta" : {
