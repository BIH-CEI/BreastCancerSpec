# Ki-67-IHC Reagenz Stanzbiopsie - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Ki-67-IHC Reagenz Stanzbiopsie**

## Example Substance: Ki-67-IHC Reagenz Stanzbiopsie
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySubstanceKi67",
  "meta" : {
