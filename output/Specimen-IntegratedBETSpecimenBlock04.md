# Paraffinblock 04 BET - RR inferior (integriert) - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Paraffinblock 04 BET - RR inferior (integriert)**

## Example Specimen: Paraffinblock 04 BET - RR inferior (integriert)
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_25_300_A_4
...
| * |  | Zuschnitt und Paraffineinbettung - RR inferior | Preparation of formalin fixed paraffin embedded tissue specimen (procedure) | 2025-02-06 08:30:00+0100 |
