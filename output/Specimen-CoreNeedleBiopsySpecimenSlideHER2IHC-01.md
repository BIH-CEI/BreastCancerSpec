# HER2-IHC Schnitt 01 Stanzbiopsie - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HER2-IHC Schnitt 01 Stanzbiopsie**

## Example Specimen: HER2-IHC Schnitt 01 Stanzbiopsie
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_25_105_A_1_1_HER2IHC_01
...
> **processing****MII EX Biobank Temperaturbedingungen**: 20-25 °C**description**: HER2 Immunhistochemie**procedure**: Human epidermal growth factor receptor 2 gene detection by immunohistochemistry (procedure)**additive**: [Substance Tissue stain (substance)](Substance-CoreNeedleBiopsySubstanceHER2IHC.md)**time**: 2025-01-16 10:20:00+0100
...
```json
{
  ...
  "id" : "CoreNeedleBiopsySpecimenSlideHER2IHC-01",
  "meta" : {
