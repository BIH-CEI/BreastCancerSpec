# Abstand von Mamille (integriert) - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Abstand von Mamille (integriert)**

## Example Observation: Abstand von Mamille (integriert)
