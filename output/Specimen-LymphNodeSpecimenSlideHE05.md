# HE-Schnitt 05 SLN #1 (Schnittstufe 5) - Breast Cancer Specification v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **HE-Schnitt 05 SLN #1 (Schnittstufe 5)**

## Example Specimen: HE-Schnitt 05 SLN #1 (Schnittstufe 5)
...
**identifier**: `https://pathologie.example-hospital.de/fhir/fn/befundbericht`/E_25_211_A_1_1_HE_05
...
> **processing****MII EX Biobank Temperaturbedingungen**: 20-25 °C**description**: Schnittherstellung (Schnittstufe 5)**procedure**: Sectioning of tissue block (procedure)**time**: 2025-02-06 09:20:00+0100
